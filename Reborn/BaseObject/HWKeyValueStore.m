...
- (void)createTableWithName:(NSString *)tableName {
  if ([HWKeyValueStore checkTableName:tableName] == NO) {
    return;
  }
...
- (id)getObjectById:(NSString *)objectId fromTable:(NSString *)tableName {
  HWKeyValueItem * item = [self getHWKeyValueItemById:objectId fromTable:tableName];
  if (item) {
...
- (HWKeyValueItem *)getHWKeyValueItemById:(NSString *)objectId fromTable:(NSString *)tableName {
  if ([HWKeyValueStore checkTableName:tableName] == NO) {
    return nil;
  }
  ...
  if (json) {
    ...
    HWKeyValueItem * item = [[HWKeyValueItem alloc] init];
...
- (NSArray *)getAllItemsFromTable:(NSString *)tableName {
  ...
  NSError * error;
  for (HWKeyValueItem * item in result) {
    error = nil;
