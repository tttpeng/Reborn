...
@interface HWWeiboPictureMetadata : HWObject
...
@interface HWWeiboPicture : HWObject
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize;
@property (nonatomic, strong) HWWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) HWWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) HWWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) HWWeiboPictureMetadata *large;
@property (nonatomic, strong) HWWeiboPictureMetadata *largest;
@property (nonatomic, strong) HWWeiboPictureMetadata *original;
@end

@interface HWWeiboURL : HWObject
...
@interface HWWeiboUser : HWObject
...
@interface HWWeiboStatus : HWObject
@property (nonatomic, assign) uint64_t statusID;
@property (nonatomic, strong) NSString *idstr;
@property (nonatomic, strong) NSString *mid;
@property (nonatomic, strong) NSString *rid;
@property (nonatomic, strong) NSDate *createdAt;
@property (nonatomic, strong) HWWeiboUser *user;
@property (nonatomic, assign) int32_t userType;
@property (nonatomic, strong) NSString *text;
@property (nonatomic, strong) NSArray *picIds;        /// Array<NSString>
@property (nonatomic, strong) NSDictionary *picInfos; /// Dic<NSString, HWWeiboPicture>
@property (nonatomic, strong) NSArray *urlStruct;     ///< Array<HWWeiboURL>
