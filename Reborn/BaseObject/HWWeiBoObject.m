...
@implementation HWWeiboPictureMetadata
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
  return @{@"picIds" : [NSString class],
           @"picInfos" : [HWWeiboPicture class],
           @"urlStruct" : [HWWeiboURL class]};
}
